export default {
  ...
  'sync.skipped.badRemoteUrl': '远程仓库必须为 owner/repo 格式，请检查设置。',
  ...
  'notice.gitNotAvailable': 'Git 后端不可用，使用 API 后端。',
  ...
  'settings.gitPathDesc': 'Git 可执行文件路径（仅桌面端）。留空以使用系统 PATH 中的 git；或填写完整 git 可执行文件路径（支持路径中含空格）。',

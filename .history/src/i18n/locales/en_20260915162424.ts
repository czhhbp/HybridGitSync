export default {
  ...
  'sync.skipped.badRemoteUrl': 'Remote repository must be in "owner/repo" format. Check settings.',
  ...
  'notice.gitignoreSaveFailed': 'Failed to save .gitignore',
  'notice.untrackGitOnly': 'Untrack is only available in Git mode',
  'notice.noIgnoredTrackedFiles': 'No ignored files are currently tracked',
  'notice.untrackedFiles': 'Untracked {count} ignored file(s)',
  'notice.untrackFailed': 'Failed to untrack ignored files',
  ...
  // .gitignore comments
  'gitignore.ignoreDotfiles': 'Ignore all dotfiles by default (prevent unknown tools from committing)',
  'gitignore.keepDotfiles': 'Keep these dotfiles',
  ...
  'settings.gitPathDesc': 'Path to git executable (desktop only). Leave empty to use system git from PATH, or provide the full path to the git binary (supports spaces in path).',
  ...
  'settings.gitignore': '.gitignore Rules',
  'settings.gitignoreRules': 'Edit .gitignore',
  'settings.gitignoreRulesDesc': 'Edit the .gitignore file to control which files are ignored',
  'settings.gitignoreSave': 'Save',
  'settings.gitignoreReset': 'Reset to Default',
